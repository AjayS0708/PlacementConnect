...
export const TEST_CHECKLIST_ITEMS: TestChecklistItem[] = [
  ...
  },
  {
    ...
    hint: 'Open /placement-readiness/resources and ensure entries can be reopened.',
  },
  {
  ...
  },
  {
    ...
    hint: 'Open browser console on /, /placement-readiness, /placement-readiness/results, /placement-readiness/resources.',
  },
];
