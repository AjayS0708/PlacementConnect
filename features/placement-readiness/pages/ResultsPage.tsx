...
import {
  ...
  updateAnalysisEntry,
} from '@/features/placement-readiness/lib/storage';
import { AnalysisEntry, SKILL_SECTION_CONFIG, SkillConfidence, SkillConfidenceMap } from '@/features/placement-readiness/types/analysis';
    ...
    return (
      <Card>
        ...
        <CardContent className="flex gap-3">
          <Link href="/placement-readiness/practice" className="rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-white hover:bg-primary/90">
            Go to Practice
          </Link>
          <Link href="/placement-readiness/resources" className="rounded-lg border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-100">
            Open History
          </Link>
        </CardContent>
      </Card>
    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="flex flex-wrap gap-2">
          ...
          <button type="button" onClick={handleDownloadTxt} className="rounded-lg bg-primary px-3 py-2 text-xs font-semibold text-white hover:bg-primary/90">Download as TXT</button>
