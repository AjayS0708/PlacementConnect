...
import { analyzeJobDescription } from '@/features/placement-readiness/lib/analysis';
import { saveAnalysisEntry } from '@/features/placement-readiness/lib/storage';
...
export function PracticePage() {
  ...
  const handleAnalyze = (event: FormEvent) => {
    ...
    router.push(`/placement-readiness/results?id=${entry.id}`);
  };
