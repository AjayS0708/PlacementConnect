...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/jt/07-test', destination: '/job-notifications', permanent: true },
      { source: '/jt/08-ship', destination: '/job-notifications', permanent: true },
      ...
      { source: '/job-notifications/test', destination: '/job-notifications', permanent: true },
      { source: '/job-notifications/ship', destination: '/job-notifications', permanent: true },
